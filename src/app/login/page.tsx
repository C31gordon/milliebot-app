      ...
      <div className="w-full max-w-md relative z-10">
            ...
            <>
              ...
              <div className="space-y-3 mb-6">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg font-semibold text-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-xs font-medium" style={{ color: 'var(--text4)' }}>or sign in with email</span>
                <div className="flex-1 h-px" style={{ background: 'var(--border)' }}></div>
              </div>
              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg text-sm transition-all duration-200 focus:ring-2 focus:ring-blue-500/50"
                    style={{
                      background: 'var(--bg)',
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 rounded-lg font-bold text-sm text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                    background: 'linear-gradient(135deg, var(--blue), var(--blue-dark))',
                    boxShadow: loading ? 'none' : 'var(--shadow-glow-blue)',
                  }}
                >
                  {loading ? (
              ...
              {resetSent ? (
                ...
                <form onSubmit={handlePasswordReset} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3 rounded-lg font-bold text-sm text-white transition-all duration-200"
        ...
        <div className="text-center mt-6">
          ...
          <p className="text-xs mt-1" style={{ color: 'var(--text4)' }}>
            © 2026 Ardexa. All rights reserved.
          </p>
        </div>
      </div>
    </div>
